...
| &ensp;Manylinux + bundleable | 175 | 11.8% |
...
| **Purelib + manylinux + bundleable** | **1409** | **94.7%** |
| **Platform/accel + other** | **79** | **5.3%** |
...
**Total:** 244 packages with ELF dependencies (170 manylinux-only, 1 bundleable, 21 accelerator, 28 unbundleable, 24 undecided, 0 unknown)
